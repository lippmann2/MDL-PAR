...
int main()
{
  ...
  G_MAGIC_NUMBER_CONTEXT_SIZE_IN_BYTES = 10;//12;
  G_MAGIC_NUMBER_NORMALIZED_CONTEXT_SIMILARITY_THRESHOLD = 0.876;
  G_MAGIC_NUMBER_NORMALIZED_SUPPORT_SIMILARITY_THRESHOLD = 0.876;
  ...
  G_MAGIC_NUMBER_NUM_APPROX_NEIGHBORS_TO_CHECK = 2000;
  G_MAGIC_NUMBER_MAX_NUM_NEIGHBORS_TO_USE = 20000;
  ...
  assert(G_MAGIC_NUMBER_MAX_RAW_CONTEXT_DISTANCE > 0);
    ...
    lg.open("/mnt/local/gdrive/public/lippmann/compression_scratch/tests/scratch/lenna_lg_c.txt");

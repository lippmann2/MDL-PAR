...
int main(int argc, char* argv[])
{
  ...
  G_MAGIC_NUMBER_CONTEXT_SIZE_IN_BYTES = 12; //~2GB, should make all other params meaningless
  ...
  G_MAGIC_NUMBER_NUM_APPROX_NEIGHBORS_TO_CHECK = 32000;
  G_MAGIC_NUMBER_MAX_NUM_NEIGHBORS_TO_USE = 32000;
